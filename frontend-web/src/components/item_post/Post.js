    ...
    <div className="w-full mx-auto p-[1rem] bg-white rounded-lg shadow-md border-2 border-[#3CA9F9] border-double overflow-hidden font-montserrat">
      ...
      <div className="flex flex-row px-2 py-2">
        ...
        <div className="flex flex-col gap-2 justify-between w-[55%] pl-4">
          <div className="grid  gap-1 p-2 text-gray-700 text-lg border-[1px] border-double border-[#3CA9F9] rounded-lg font-bold">
            <div className="flex gap-36">
              <p className="text-red-600 mt-2 p-1 text-center">
            ...
            <div>
              <p className="mt-2 border-[1px] border-[#3CA9F9] border-double rounded-xl p-1 text-left shadow-sm shadow-gray-500 bg-gradient-to-r from-[#E4FFFC] via-blue-200 to-blue-200 transition-all duration-500 hover:shadow-2xl">
