...
if (days < 3) {
  if (days >= 2) {
    ...
    timeDisplay = `Hôm qua vào lúc ${postDate.toLocaleTimeString("vi-VN", { hour: '2-digit', minute: '2-digit' })}`;
  } else if (hours >= 1) {
  ...
  timeDisplay = `${postDate.toLocaleDateString(
    "vi-VN"
  )} vào lúc ${postDate.toLocaleTimeString("vi-VN", { hour: '2-digit', minute: '2-digit' })}`;
}
